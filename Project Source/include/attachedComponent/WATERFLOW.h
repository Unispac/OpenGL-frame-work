...
private:
	...
	void initialWave()
	{
		...
		Toolkit::myLight->setLight(myShader);
		myShader->setFloat1("material.shininess",256.0);
		myShader->setBool("material.texture_diffuse0_exist", false);
		myShader->setBool("material.texture_specular0_exist", false);
		myShader->setFloat4("material.texture_specular_color", 0.5f,0.5f,0.5f,1.0f);
		myShader->setFloat4("material.texture_diffuse_color", 0.118f,0.565f,1.0f,1.0f);
		myShader->setFloat4("material.texture_ambient_color", 0.2f,0.2f,0.2f, 1.0f);
