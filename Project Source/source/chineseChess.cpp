...
#include<renderingEngine/SKY.h>
#include<renderingEngine/TEXT.h>
#include<myChess/CHESSBOARD.h>
...
int main()
{
	...
	Light myLight
	(glm::vec3(0, 100.0, 0.0), glm::vec3(0.4f, 0.4f, 0.4f), glm::vec3(1.0f, 1.0f, 1.0f),
		glm::vec3(1.0f, 1.0f, 1.0f), true,glm::vec3(1.0f, 0.0015f, 0.000007f));
	Toolkit::myLight = &myLight;
